...
import { kiroCancel, kiroListSessions, kiroPrompt } from "./tools.js";
...
export function buildServer(ctx) {
    ...
    server.registerTool("kiro_prompt", {
        description: "Delegate a task to the local kiro-cli coding agent and wait for the result. " +
    ...
    server.registerTool("kiro_cancel", {
    ...
    server.registerTool("kiro_list_sessions", {
